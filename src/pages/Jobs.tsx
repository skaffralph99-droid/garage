...
import { Plus, ChevronLeft, Wrench, LogOut, Car } from 'lucide-react'
    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center justify-between animate-fade-up">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-g-steel text-2xl font-black">GarageApp</h1>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="flex gap-2 animate-fade-up delay-1">
        <div className="flex-1 bg-g-red/10 border border-g-red/20 rounded-xl p-3 text-center">
          ...
          <p className="text-g-dim text-[10px]">شغل حالي</p>
        </div>
        <div className="flex-1 bg-green-500/10 border border-green-500/20 rounded-xl p-3 text-center">
          ...
          <p className="text-g-dim text-[10px]">مكتمل</p>
        </div>
        <div className="flex-1 bg-g-card border border-g-border rounded-xl p-3 text-center">
          ...
          <p className="text-g-dim text-[10px]">إجمالي الأرباح</p>
        </div>
      </div>
      ...
      <Link to="/new" className="block animate-fade-up delay-2">
        <div className="relative overflow-hidden rounded-2xl p-4" style={{ background: 'linear-gradient(135deg, #DC2626, #EF4444, #F87171)' }}>
          <div className="flex items-center gap-3 relative z-10">
            ...
            <div>
              <p className="text-white font-black text-base">سيارة جديدة</p>
              <p className="text-white/70 text-xs">سجّل سيارة دخلت الكراج</p>
            </div>
          </div>
      ...
      {open.length > 0 && (
        <div className="animate-fade-up delay-3">
          <p className="text-g-red text-[11px] font-bold tracking-widest mb-3">🔴 شغل حالي</p>
      ...
      {completed.length > 0 && (
        <div className="animate-fade-up delay-4">
          <p className="text-green-400 text-[11px] font-bold tracking-widest mb-3">✅ مكتمل</p>
          <div className="space-y-2">
            {completed.map((j, i) => (
      ...
      {jobs.length === 0 && (
        <div className="text-center py-16 animate-fade-in">
          ...
          <p className="text-g-dim text-sm">لا توجد سيارات بعد</p>
          <Link to="/new" className="text-g-red text-sm font-bold mt-2 inline-block">+ سجّل أول سيارة</Link>
        </div>
      )}
    </div>
  )
